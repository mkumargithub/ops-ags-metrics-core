...
public class JmxReporter implements Reporter, Closeable {
    ...
    private static class JmxHistogram implements JmxHistogramMBean {
        ...
        @Override
        public double get90thPercentile() { return metric.getSnapshot().get90thPercentile();}

        @Override
        public double get95thPercentile() { return metric.getSnapshot().get95thPercentile();}
